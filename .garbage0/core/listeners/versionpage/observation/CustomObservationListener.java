...
public class CustomObservationListener implements EventListener {
    ...
    public void activate(ComponentContext context) throws Exception {
        try {
            final String[] nodeTypes = {"cq:PageContent"};
            final int eventTypes = Event.PROPERTY_ADDED | Event.PROPERTY_CHANGED | Event.PROPERTY_REMOVED | Event.NODE_ADDED | Event.NODE_MOVED | Event.NODE_REMOVED;
...
//            // Register the JCR Listener
            observationManager.addEventListener(
                    this, //handler
                    Event.PROPERTY_ADDED | Event.PROPERTY_CHANGED | Event.PROPERTY_REMOVED | Event.NODE_ADDED | Event.NODE_MOVED | Event.NODE_REMOVED, // events types
//                    "/content/learn/us/*/jcr:content/root", //path
                    "/content/learn/us/en/jcr:content/root/", //path
//                    "/content/learn/us/en/jcr:content", //path
                    true, //isDeep
                    null, //uuids filter
                    null,
                    false
    ...
    public void onEvent(final EventIterator events) {
        try {
            ...
            if (event instanceof JackrabbitEvent && ((JackrabbitEvent) event).isExternal()) {
                ...
                jobProperties.put("pageEventByEventObservation", path);
                jobManager.addJob("aem/custom/pageEventByEventObservation", jobProperties);
            }
