...
@Component(
        ...
        property = {
                JobConsumer.PROPERTY_TOPICS + "=" + "aem/custom/tableEvent"
        }
)
@Designate(ocd = TableListenerConfig.class)
public class JobTableListener implements JobConsumer {
    private final Logger logger = LoggerFactory.getLogger(this.getClass().getName());
    private boolean activateTopic;

    @Activate
    @Modified
    public void activate(TableListenerConfig tableListenerConfig) {
        this.activateTopic = tableListenerConfig.activateTopic();
    }
    ...
    void workObservationListener(Job job) throws RepositoryException {
        String modificationPath = (String) job.getProperty("tableEvent");
