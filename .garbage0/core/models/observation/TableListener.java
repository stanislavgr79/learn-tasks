...
//            // Register the JCR Listener
            observationManager.addEventListener(
                    this, //handler
                    Event.PROPERTY_ADDED | Event.PROPERTY_CHANGED | Event.PROPERTY_REMOVED, // events types
    ...
    public void onEvent(final EventIterator events) {
        try {
            ...
            if (event instanceof JackrabbitEvent && ((JackrabbitEvent) event).isExternal()) {
                ...
                jobProperties.put("tableEvent", path);
                jobManager.addJob("aem/custom/tableEvent", jobProperties);
            }
